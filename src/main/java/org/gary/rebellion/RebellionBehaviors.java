...
import org.gary.dice.DieResult;
import java.util.List;
import java.util.Map;
import net.dv8tion.jda.api.entities.MessageChannel;
import org.jetbrains.annotations.NotNull;
import org.gary.rebellion.events.RebellionEvent;
...
public class RebellionBehaviors {
	...
	public static Behavior getSetSkillFocusBehavior() {
		return new Behavior() {
			...
			@Override
			public List<String> getFormattedHelp(DeckList<String> s, String key) {
				return List.of(NachoHelpBehavior.formatHelp(key,"Sets the org.gary.rebellion Skill Focus: none, loyalty, secrecy, security."));
			}
		};
	}
	...
	public static Behavior getSetMaxRankBehavior() {
		return new Behavior() {
			...
			@Override
			public List<String> getFormattedHelp(DeckList<String> s, String key) {
				return List.of(NachoHelpBehavior.formatHelp(key,"Sets the maximum rank the org.gary.rebellion can reach"));
			}
		};
	}
	...
	public static Behavior getRollLoyaltyBehavior() {
		return new Behavior() {
			...
			@Override
			public List<String> getFormattedHelp(DeckList<String> s, String key) {
				return List.of(NachoHelpBehavior.formatHelp(key,"Rolls using your org.gary.rebellion's loyalty bonus."));
			}
		};
	}
	...
	public static Behavior getRollSecrecyBehavior() {
		return new Behavior() {
			...
			@Override
			public List<String> getFormattedHelp(DeckList<String> s, String key) {
				return List.of(NachoHelpBehavior.formatHelp(key,"Rolls using your org.gary.rebellion's secrecy bonus."));
			}
		};
	}
	...
	public static Behavior getRollSecurityBehavior() {
		return new Behavior() {
			...
			@Override
			public List<String> getFormattedHelp(DeckList<String> s, String key) {
				return List.of(NachoHelpBehavior.formatHelp(key,"Rolls using your org.gary.rebellion's security bonus."));
			}
		};
	}
	...
	public static Behavior getPrintsTheRebellionSheetBehavior() {
		return new Behavior() {
			...
			@Override
			public List<String> getFormattedHelp(DeckList<String> s, String key) {
				return List.of(NachoHelpBehavior.formatHelp(key, "prints the org.gary.rebellion sheet"));
			}
		};
	}
	...
	private static Behavior getSetBehavior() {
		return new Behavior() {
			...
			public void run(DeckList<String> message, MessageChannel channel) {
				if (message.canDraw()) {
					try {
						...
						channel.sendMessage("This Channel now using org.gary.rebellion: "+id).queue();
					}catch (NumberFormatException e){
						channel.sendMessage("org.gary.rebellion ids are numbers").queue();
					}
				}
			}
			...
			public List<@NotNull String> getFormattedHelp(DeckList<String> s, String key) {
				return List.of(NachoHelpBehavior.formatHelp(key, "allows you to set what org.gary.rebellion the current channel is mapped to"));
			}
		};
	}
